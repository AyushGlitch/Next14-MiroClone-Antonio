...
export const Toolbar = ({
    ...
    return (
        <div className=" absolute left-2 top-1/2 flex flex-col gap-y-4 -translate-y-1/2">
...
export const ToolbarSkeleton = () =>  {
    return (
        <div className=" absolute top-1/2 -translate-y-1/2 left-2 flex flex-col bg-white h-[360px] w-[52px] shadow-md rounded-md"
        />
    )
}